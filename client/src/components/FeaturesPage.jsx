...
const features = [
  ...
  },
  {
    ...
    description: 'النسخة المستقلة مخصصة للنصوص الأساسية والتوسعات البحثية: الأسفار القانونية الثانية، التقليد الإثيوبي، الدسقولية، التوراة السامرية، السبعينية، البيشيطا، الفولجاتا، والمنحولات. تتضمن الدفعة الحالية أخنوخ الأول والثاني والثالث بالإنجليزية، والجعزي، واليوبيلات، والدسقولية، والمكابيان الإثيوبي بالإنجليزية، ووصية موسى/صعود موسى بالإنجليزية واللاتينية، وباروخ الثاني والثالث، ورؤيا إبراهيم، ووصية إبراهيم بنسختين، ووصية أيوب، ويوسف وأسنات، وحياة آدم وحواء، ورسالة أريستاس، وأقوال العرافات، وشواهد رؤيا حزقيال، وكتاب العمالقة المانوي، ووصية سليمان، والديداخي، وإنجيل يعقوب التمهيدي، ورسالة برنابا، وصيغ إنجيل طفولة توما، وإنجيل توما بأقواله المئة والأربعة عشر، وإنجيل مريم، وإنجيل بطرس، وإنجيل نيقوديموس بالإنجليزية. يسجل الموقع لغة كل شاهد وحالته ومصدره، ويترك مكاناً للترجمة العربية اللاحقة.',
