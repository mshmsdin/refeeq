...
const features = [
  ...
  },
  {
    ...
    description: 'انتقل إلى الأسفار والأصحاحات والأعداد، وابحث بكلمة أو بمرجع، واقرأ أكثر من ترجمة مع إمكان المقارنة والنسخ الموثق. تتوفر نسخة مستقلة للبيبل على نطاق منفصل.',
    tips: ['انتقل إلى سفر أو إصحاح أو عدد مباشرة', 'انقر شعار البيبل للعودة إلى الواجهة', 'قارن الترجمات المتاحة', 'انسخ العدد مع توثيقه', 'النسخة المستقلة: wiki.din.hk/bible'],
  },
  {
    icon: Languages,
    tone: 'teal',
    ...
    description: 'النسخة المستقلة مخصصة للنصوص الأساسية والتوسعات البحثية: الأسفار القانونية الثانية، التقليد الإثيوبي، الدسقولية، التوراة السامرية، السبعينية، البيشيطا، الفولجاتا، والمنحولات. تتضمن الدفعة الحالية أخنوخ الأول والثاني والثالث بالإنجليزية والجعزية، واليوبيلات، والدسقولية، والدسقولية الإثيوبية، والمكابيان الإثيوبي، ووصية موسى/صعود موسى بالإنجليزية واللاتينية، وباروخ الثاني والثالث، ورؤيا إبراهيم، ووصيتي إبراهيم، ووصية أيوب، ويوسف وأسنات، وحياة آدم وحواء، ورسالة أريستاس، وأقوال العرافات، وشواهد رؤيا حزقيال، وكتاب العمالقة المانوي، ووصية سليمان، والديداخي، وإنجيل يعقوب التمهيدي، وبرنابا، وصيغ إنجيل طفولة توما، وإنجيل توما، وإنجيلي مريم وبطرس ونيقوديموس ويهوذا، وشواهد أعمال بولس وأعمال بطرس ورؤيا بطرس، والشاهد الإنجليزي للتوراة السامرية في الأسفار الخمسة. وتضيف الآن الرسالتين الأولى والثانية لإكليمندس وأجزاء راعي هرماس الثلاثة، وتغسات/سينودوس تيزّاز وكتابَي العهد الأول والثاني وإكليمندس الإثيوبي الثاني بالإنجليزية. يسجل الموقع لغة كل شاهد وحالته ومصدره، ويترك مكاناً للترجمة العربية اللاحقة، ويستبعد أي وحدة تالفة من المصدر مع بيان السبب.',
    tips: ['رفيق يحتفظ بالنصوص الأساسية فقط', 'كل عمل موسع يسجل كعمل مستقل لا كإضافة عشوائية', 'النص غير المستورد يظهر بحالة قيد الإعداد', 'افتح السفر واختر الشاهد أو الترجمة من صفحة العمل', 'المقارنة العلمية تعرض الفرق بين الشواهد والترجمات'],
  },
  {
    icon: BarChart3,
    tone: 'indigo',
