...
const features = [
  ...
  },
  {
    ...
    description: 'النسخة المستقلة مخصصة للنصوص الأساسية والتوسعات البحثية: الأسفار القانونية الثانية، التقليد الإثيوبي، الدسقولية، التوراة السامرية، السبعينية، البيشيطا، الفولجاتا، والمنحولات. تتضمن الدفعة الحالية أخنوخ الأول والثاني والثالث بالإنجليزية، والجعزي، واليوبيلات، والدسقولية، والمكابيان الإثيوبي بالإنجليزية، ووصية موسى/صعود موسى بالإنجليزية واللاتينية، وباروخ الثاني والثالث، ورؤيا إبراهيم بالإنجليزية. يسجل الموقع لغة كل شاهد وحالته ومصدره، ويترك مكاناً للترجمة العربية اللاحقة.',
