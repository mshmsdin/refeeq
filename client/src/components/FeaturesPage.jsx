...
const features = [
  ...
  },
  {
    ...
    description: 'النسخة المستقلة مخصصة للنصوص الأساسية والتوسعات البحثية: الأسفار القانونية الثانية، التقليد الإثيوبي، الدسقولية، التوراة السامرية، السبعينية، البيشيطا، الفولجاتا، والمنحولات. يسجل الموقع لغة كل شاهد وحالته ومصدره، ويترك مكاناً للترجمة العربية اللاحقة.',
    tips: ['رفيق يحتفظ بالنصوص الأساسية فقط', 'كل عمل موسع يسجل كعمل مستقل لا كإضافة عشوائية', 'النص غير المستورد يظهر بحالة قيد الإعداد', 'المقارنة العلمية تعرض الفرق بين الشواهد والترجمات'],
  },
  {
    icon: BarChart3,
    tone: 'indigo',
