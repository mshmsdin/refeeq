...
const features = [
  ...
  },
  {
    ...
    description: 'النسخة المستقلة مخصصة للنصوص الأساسية والتوسعات البحثية: الأسفار القانونية الثانية، التقليد الإثيوبي، الدسقولية، التوراة السامرية، السبعينية، البيشيطا، الفولجاتا، والمنحولات. تتضمن الدفعة الحالية أخنوخ الأول بالإنجليزية والجعزية، واليوبيلات، والدسقولية، ووصية موسى/صعود موسى بالإنجليزية واللاتينية. يسجل الموقع لغة كل شاهد وحالته ومصدره، ويترك مكاناً للترجمة العربية اللاحقة.',
