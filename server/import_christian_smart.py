...
# ----------------------------------------------------
CATEGORIES = [
    'تحريف البيبل والنقد النصي وتناقضات الأناجيل',
    ...
    'الأخلاق والتشريعات والعنف والحروب في البيبل',
...
def determine_category(text, tags):
    ...
    if any(k in combined for k in [
        ...
        return 'تحريف البيبل والنقد النصي وتناقضات الأناجيل'
    ...
    if any(k in combined for k in [
        ...
        return 'الأخلاق والتشريعات والعنف والحروب في البيبل'
    ...
    if any(k in combined for k in [
        ...
        'قاموس البيبل', 'الاب متى المسكين', 'الخوري', 'القس', 'الشماس', 'تفسير انطونيوس فكري',
